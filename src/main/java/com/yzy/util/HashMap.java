...
public class HashMap<K,V> extends AbstractMap<K,V>
     ...
     */
    static final int DEFAULT_INITIAL_CAPACITY = 1 << 4; // aka 16 默认hash桶容量
     ...
     */
    static final int MAXIMUM_CAPACITY = 1 << 30; // 最大容量？ 1073741824 2的30次方
     ...
     * shrinkage.
     */
    static final int TREEIFY_THRESHOLD = 8; // 当数组下标的链表长度超过这个数，这个链表会变成红黑树
